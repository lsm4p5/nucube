...
import uplus.nucube.common.trace.dto.db.*;
...
//        String fieldAnnotation;
        ...
        Map<Object, String> clientType = getObjectValue1();
        Map<Object, String> clientPara = getParaValue1();

        for (Object o : clientType.keySet()) {
            clientTest.setUuid( getUuid() );
            clientTest.setInput_depth( 1 );
            clientTest.setInputType1( o +"");
            clientTest.setInputPara1( clientPara.get(o));
            clientTest.setInputValue( o +"");
        }
        clientEntity.getClientTests().add( clientTest );
